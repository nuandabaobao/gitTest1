 ...
 */
@WebFilter(urlPatterns = "/portal/*", filterName = "tokenFilter")
public class TokenFilter implements Filter{
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        //通过session获取employee
        Employee employee=(Employee)request.getSession().getAttribute("PORTAL_EMP");
        if(employee==null || emp.getId()!=employee.getId()){
            //向session放入数据
            request.getSession().setAttribute("PORTAL_EMP",emp);
        }
